...
set(_blacs_lib ${LAPACK_LIBRARIES})
if (NOT BLA_STATIC)
  list(PREPEND _blacs_lib -lmkl_blacs_${_mkl_blacs_mpi_abi}_${_mkl_fortran_int})
else(NOT BLA_STATIC)
  list(PREPEND _blacs_lib "${_mkl_lib_dir}/libmkl_blacs_${_mkl_blacs_mpi_abi}_${_mkl_fortran_int}${_mkl_static_library_suffix}")
  if (_cmake_system_name STREQUAL Linux)
