...
if (NOT BLA_STATIC)
  ...
  set(_mkl_libraries "${_mkl_lib_dir}/libmkl_intel_${_mkl_fortran_int}${CMAKE_STATIC_LIBRARY_SUFFIX}" "${_mkl_lib_dir}/libmkl_${_mkl_backend_id}${CMAKE_STATIC_LIBRARY_SUFFIX}" "${_mkl_lib_dir}/libmkl_core${CMAKE_STATIC_LIBRARY_SUFFIX}")
  if (_cmake_system_name STREQUAL Linux)
